...
Sử dụng http.Client: Một đối tượng quản lý vòng đời của Request (bao gồm nhiều thành phần bên trong như timeout, redirect, cookie).
